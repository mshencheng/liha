...
public class AllConfig {
    public static final String cron = "0 55 21 * * ?"; //分别代表：秒、分、时、日、月、星期
    ...
    public static final String WeatherKey_HeFeng = "32f5ffb55a884b4783bc85ed552ea520";
    ...
    private static void init(){
        ...
        userList.add(getUser(
                "o5YIX6G_wCDF0kS_1EO0tKUlj2_c", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "iYYUrNGv3NO3jxCOBgSSQNNwsBuS57LzAgACObRSGJw", //要给这个人发送的模板ID
                "竹子", //咋称呼这个人
                "江苏省南京市玄武区", //这个人的详细地址
                "南京", //这个人在的城市
